...
2. **阅读** — 逐句阅读，点一下单词就能看到释义和读音，并可按需要调整文字大小
3. **积累** — 生词和常用搭配自动收进你的词库；文件页会显示其中词汇和词组的学习进度
...
- **智能复习** — 间隔重复，赶在你忘记之前提醒
- **从高频词起步** — 可选择将英语或中文最高频的 1,000–10,000 个词先标为已掌握，再每天抽查少量词汇
- **进度可追溯到原文** — 打开任一已导入文件，继续阅读并查看其中单词和词组的学习进度
