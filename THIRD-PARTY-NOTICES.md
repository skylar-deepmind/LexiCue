...
| wordfreq frequency baseline (v3.1.1) | en, zh | https://github.com/rspeer/wordfreq | CC BY-SA 4.0 data; Apache-2.0 generator package | `frequency-baseline/NOTICE.md` |
...
The optional English and Chinese high-frequency baseline lists are derived from
the `wordfreq` 3.1.1 data. They are generated by
`scripts/build_frequency_baseline.py` and embedded in the application. Keep
the attribution and CC BY-SA 4.0 notice in `frequency-baseline/NOTICE.md` when
redistributing the application or these lists.
