...
export default function WordDetailPanel({ detail, onClose, onStatusChange, onDefinitionSave, onOccurrenceOpen }: WordDetailProps) {
  ...
  return (
    <aside role="dialog" aria-modal="true" aria-labelledby="word-detail-title" className="ui-sheet fixed inset-y-0 right-0 z-40 flex w-full flex-col border-l sm:w-96">
      <div className="flex items-center justify-between p-4 border-b border-gray-100">
        <h2 id="word-detail-title" className={`font-semibold text-gray-900 ${CONTENT_FONT_CLASS.learning[learningTextFontSize]}`}>{detail.word.lemma}</h2>
